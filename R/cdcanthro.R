...
cdcanthro <- function(data, age=age_in_months, wt=weight_kg, ht=height_cm, bmi=bmi)
{
   ...
   adj_bmi_met <- adj_bmi_met[,':='
                               (mref=round(mref,5), sref=round(sref,5))
                              ]
   ...
   setnames(dt,
      c('adist',  'aperc',  'bp',   'bz',  'mbz',     'mwaz',   'mhaz',
        'ebp',    'ebz',    'l',    'm',    's', 'wp', 'hp',
        'perc', 'perc0', 'aperc0'),
      c('adj_dist','adj_perc','bmip','bmiz','mod_bmiz','mod_waz','mod_haz',
        'ext_bmip','ext_bmiz', 'bmi_l','bmi_m','bmi_s','wap', 'hap',
        'perc_median', 'log_perc_median', 'adj_log_perc_median')
   )

   v=c('seq_', 'bmiz', 'bmip', 'waz', 'wap', 'haz', 'hap', 'p50', 'p95',
       'p97', 'bmip95', 'mod_bmiz', 'mod_waz', 'mod_haz',  'ext_bmip',
       'ext_bmiz', 'adj_dist', 'dist', 'adj_perc', 'perc_median',
       'log_perc_median', 'adj_log_perc_median')
   dt <- dt[,..v]
